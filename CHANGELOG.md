...
- Fork package from https://github.com/retyui/react-native-confirmation-code-field
- Add setValueOTP callback function to set code, use on React Native Web class
- Fix deprecated `substr` function by `substring`
